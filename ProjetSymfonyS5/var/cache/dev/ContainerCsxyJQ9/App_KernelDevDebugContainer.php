...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Chayn6ej03', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Rz1wPgIHLw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H0OZlkbL75', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PfD0dChLI6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    /**
     * Gets the private '.service_locator.DE_8AZb' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_DE8AZbService($container)
    {
        return $container->privates['.service_locator.DE_8AZb'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('adLOs7YmGj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eodvCDC1vx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WK6gc4YKQq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vmMVloR5yP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.graphql.cache.subscription'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B13OPiSX7d', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BXOB1ziOzi', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3v-hCSTQN4', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ti9hrka1VB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('STVWvA08iq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ML7rTOILw-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zYmrt4iHre', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $u = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $k, $g, $a, $t, NULL, [], $a);
        $v = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL);

        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\GraphQl\Serializer\Exception\ValidationExceptionNormalizer($container->parameters['api_platform.exception_to_status']), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\GraphQl\Serializer\Exception\HttpExceptionNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\GraphQl\Serializer\Exception\RuntimeExceptionNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\GraphQl\Serializer\Exception\ErrorNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $m, $n, $l, $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $d, $l), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($l, true, []), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: $r), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\GraphQl\Serializer\ItemNormalizer($c, $m, $d, $s, $n, $g, $k, $o, NULL, $b, $f), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($q, $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $k), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $k, $a, $t, NULL, [])), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($r), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($e, $n, $d, NULL), 'page', 'pagination', $b, $g, 1), $b, $n, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], []))), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($u, $d, $e), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\GraphQl\Serializer\ObjectNormalizer($u, $d, $s), $h), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($u, $h)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder($i, $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder($v, $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $v), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $h), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $h)]), $h);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \Symfony\UX\Turbo\Twig\TwigExtension(($container->privates['api_platform.graphql.resolver_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), 'default'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->setGroupProviderLocator(($container->privates['api_platform.graphql.resolver_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])));
